					...
					<div class="form-group">
						...
						<label>Loan Type</label>
							<select class="form-control" name="loan_type" id="loan_type" required>
							  ...
							  <option value="Only Interest">Only Interest</option>
							  <option value="Interest with installments">Interest with installments</option>
							  <option value="Only Installments">Only Installments</option>
